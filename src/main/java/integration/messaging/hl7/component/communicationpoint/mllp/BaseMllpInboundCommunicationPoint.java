...
/**
 * Base class for all MLLP input communication points.  This components reads the HL7 message, stores
 * it, writes an event and returns an ack.
 * 
...
public abstract class BaseMllpInboundCommunicationPoint extends BaseInboundCommunicationPoint {
	...
	public void configure() throws Exception {
		...
		from(getFromUriString())
			.routeId("messageReceiver-" + identifier.getComponentPath())
